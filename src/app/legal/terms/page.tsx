export const metadata = { title: 'Términos de Servicio · Pergamo [BORRADOR]' }
...
export default function TermsPage() {
    return (
        <>
            ...
            <p>Pergamo es operado por Rafael Bernardo Sanz Espinoza ("nosotros", "Pergamo"). Cualquier referencia a "nosotros" o "la Plataforma" se refiere a esta entidad.</p>

            <h2>2. Quién puede usar Pergamo</h2>
            <ul>
                ...
                <li>No puedes usar Pergamo si has sido previamente suspendido o si tu jurisdicción prohíbe el uso de plataformas similares.</li>
            </ul>

            <h2>3. Tipos de cuenta</h2>
            <p>Pergamo ofrece dos tipos de cuenta:</p>
            <ul>
            ...
            <h3>4.1. Propiedad</h3>
            <p>Tú mantienes la propiedad intelectual de todo el contenido que publicas en Pergamo ("Contenido del Usuario"). Pergamo no reclama propiedad sobre tus historias, fotos, ni metadatos.</p>

            <h3>4.2. Licencia que nos otorgas</h3>
            <p>Al publicar contenido en Pergamo, nos otorgas una licencia <strong>no exclusiva, mundial, sin regalías y revocable</strong> para alojar, almacenar, reproducir, mostrar, transmitir y distribuir tu Contenido del Usuario, exclusivamente con el propósito de operar la Plataforma. Esta licencia incluye:</p>
            <ul>
            ...
            <ul>
                ...
                <li>Usar Pergamo para spam, phishing o cualquier actividad fraudulenta</li>
            ...
            <h3>6.1. Por parte de Pergamo</h3>
            ...
            <p>Pergamo usa Stripe Connect para procesar pagos. Los detalles del modelo de monetización están en los <a href="/legal/creator-terms">Creator Terms</a>. En resumen:</p>
            <ul>
                <li>Los lectores pagan a los escritores directamente vía Stripe</li>
                <li>Pergamo retiene una comisión del 12% sobre cada transacción</li>
            ...
            <h2>8. Propiedad de Pergamo</h2>
            <p>El nombre "Pergamo", el logo, el código fuente, el diseño, las marcas y todo lo relacionado con la Plataforma es propiedad de Rafael Bernardo Sanz Espinoza. No puedes copiar, modificar, distribuir ni hacer ingeniería inversa sin permiso escrito.</p>

            <h2>9. Limitación de responsabilidad</h2>
            <h3>9.1. Pergamo NO certifica veracidad de las historias</h3>
            <p>Pergamo es una plataforma. <strong>No verificamos la veracidad absoluta de las historias publicadas.</strong> Implementamos señales de confianza (verificación opcional de identidad, badges de constancia, detección de plagio) pero estas son indicativas, no garantías. Cada lector debe ejercer su propio criterio sobre el contenido.</p>

            <h3>9.2. Servicio "tal cual"</h3>
            <p>Pergamo se ofrece "tal cual" y "según disponibilidad". No garantizamos:</p>
            <ul>
            ...
            <p>En la máxima extensión permitida por la ley, la responsabilidad total de Pergamo hacia ti por cualquier reclamación está limitada al monto que pagaste a la Plataforma en los últimos 12 meses (excluyendo pagos a escritores).</p>

            <h2>10. Indemnización</h2>
            <p>Aceptas indemnizar y mantener libre de daño a Pergamo ante cualquier reclamación derivada de: (a) tu Contenido del Usuario; (b) tu violación de estos Términos; (c) tu violación de derechos de terceros.</p>
            ...
            <ul>
                ...
                <li>Estos Términos constituyen el acuerdo completo entre tú y Pergamo</li>
            </ul>
