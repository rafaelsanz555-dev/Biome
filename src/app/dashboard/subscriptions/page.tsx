                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {subs.map((s: any) => (
                        <Link
                            ...
                            className="group block bg-[#15171C] rounded-2xl border border-gray-800 p-5 transition-all hover:border-green-500/30 hover:shadow-[0_8px_30px_rgba(34,197,94,0.15)] hover:-translate-y-0.5"
                        >
                            <div className="flex items-center gap-3 mb-3">
                                <div className="w-12 h-12 rounded-full overflow-hidden bg-green-500/10 flex items-center justify-center font-bold text-green-400 shrink-0">
                            ...
                            <div className="flex items-center justify-between border-t border-gray-800 pt-3">
                                <span className="text-[10px] px-2 py-1 rounded-md bg-green-500/10 text-green-400 font-bold uppercase tracking-wider flex items-center gap-1">
