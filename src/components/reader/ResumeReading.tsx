        ...
        <div className="rounded-2xl border border-gray-800 bg-gradient-to-br from-[#0F1114] to-[#0A0B0E] p-5 mb-6">
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2">
                    <BookOpen size={16} className="text-[#D8BA63]" />
                        ...
                        >
                            <div className="w-16 h-16 rounded-lg overflow-hidden shrink-0 bg-[#15171C]">
                                {ep.cover_image_url ? (
                                    ...
                                    <div className="w-full h-full bg-gradient-to-br from-[#2A2418]/40 to-[#0F1114]" />
                                )}
                            </div>
                            <div className="flex-1 min-w-0">
                                <p className="text-sm font-bold text-white line-clamp-2 group-hover:text-[#D8BA63] transition">
                                    {ep.title}
                                </p>
                            ...
                            <ArrowRight size={14} className="text-gray-600 group-hover:text-[#D8BA63] transition self-center shrink-0" />
                        </Link>
                    )
                })}
            </div>
