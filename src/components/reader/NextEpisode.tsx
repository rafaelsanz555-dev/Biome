...
export function NextEpisode({ creatorUsername, episode, seriesProgress }: NextEpisodeProps) {
    if (!episode) {
        ...
        return (
            <div className="my-12 p-8 rounded-2xl border border-gray-800 bg-gradient-to-br from-[#0F1114] to-[#15171C] text-center">
                <Sparkles className="text-[#D8BA63] mx-auto mb-3" size={28} />
                ...
                <Link
                    ...
                    className="mt-5 inline-flex items-center gap-2 text-sm text-[#D8BA63] hover:text-[#E2C96E] font-semibold"
                >
    ...
    return (
        <Link
            ...
            className="group block my-12 rounded-2xl border border-gray-800 hover:border-[#C9A84C]/50 bg-gradient-to-br from-[#0F1114] to-[#15171C] overflow-hidden transition"
        >
            <div className="p-2">
                <div className="flex items-stretch gap-0 rounded-xl overflow-hidden">
                    ...
                    <div className="flex-1 p-5">
                        <div className="flex items-center justify-between gap-2 mb-2">
                            <span className="text-[10px] uppercase tracking-wider font-bold text-[#D8BA63]">
                                Siguiente episodio
                        ...
                        <h3 className="text-lg font-bold text-white group-hover:text-[#D8BA63] transition mb-1.5 leading-snug" style={{ fontFamily: 'Georgia, serif' }}>
                            {episode.title}
                        </h3>
                        ...
                        <div className="mt-3 flex items-center gap-2 text-xs">
                            {episode.is_subscription_only && (
                                <span className="px-2 py-0.5 rounded-full bg-[#C9A84C]/10 text-[#D8BA63] border border-[#C9A84C]/20 text-[10px] font-bold">
                                    Exclusivo
                                </span>
                            )}
                            ...
                            <span className="ml-auto inline-flex items-center gap-1 text-[#D8BA63] font-semibold">
