        ...
        <div className="fixed inset-0 z-[200] bg-black/90 backdrop-blur-md flex flex-col">
            ...
            <div className="flex items-center justify-between p-4 border-b border-white/10 bg-black/50">
                <div className="flex items-center gap-3">
                    <span className="text-xs font-bold uppercase tracking-wider text-[#D8BA63]">Vista previa</span>
                ...
                <div className="flex items-center gap-1 p-1 rounded-lg bg-white/5">
                    <button
                        ...
                        className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-bold transition ${
                            mode === 'desktop' ? 'bg-[#C9A84C]/15 text-[#D8BA63]' : 'text-gray-500 hover:text-white'
                        }`}
                    >
                    ...
                    <button
                        ...
                        className={`flex items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-bold transition ${
                            mode === 'mobile' ? 'bg-[#C9A84C]/15 text-[#D8BA63]' : 'text-gray-500 hover:text-white'
                        }`}
                    >
            ...
            <div className="flex-1 overflow-y-auto p-6 flex justify-center">
                ...
                >
                    ...
                    <div className="p-6">
                        ...
                        {previewText && (
                            <div className="text-lg italic text-gray-400 border-l-4 border-[#C9A84C] pl-5 py-1 mb-6" style={{ fontFamily: 'Georgia, serif' }}>
                                {previewText}
                            </div>
                        )}

                        <div
                            className="bio-reader-content prose prose-invert max-w-none selection:bg-[#C9A84C]/40"
