...
export function EarningsCalculator() {
    ...
    return (
        <section className="py-20 px-6 border-b border-gray-800/60 bg-[#0A0B0E] relative overflow-hidden">
            <div className="absolute left-1/2 top-0 -translate-x-1/2 w-[600px] h-[300px] bg-[#C9A84C]/10 blur-[100px] rounded-full pointer-events-none" />

            <div className="max-w-4xl mx-auto relative z-10">
                <div className="text-center mb-10">
                    <div className="inline-block px-4 py-1.5 rounded-full bg-[#C9A84C]/10 text-[#D8BA63] border border-[#C9A84C]/20 text-[11px] font-bold tracking-wider uppercase mb-4">
                    ...
                    <p className="text-gray-400 max-w-lg mx-auto leading-relaxed">
                        ...
                        <strong className="text-[#D8BA63]">90%</strong> — bio.me retiene solo 10%.
                    </p>
                </div>
                ...
                <div className="max-w-xl mx-auto mb-12 bg-[#15171C] border border-gray-800 rounded-2xl p-6">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <span className="text-3xl font-black text-[#D8BA63] tracking-tight">
                            ${price}
                        ...
                        return (
                            <div
                                ...
                                className={`text-center p-6 rounded-2xl border transition-all ${
                                    tier.featured
                                        ? 'bg-gradient-to-br from-[#2A2418]/30 to-[#15171C] border-[#C9A84C]/30 shadow-[0_10px_40px_-10px_rgba(201, 168, 76,0.3)] md:scale-105'
                                        : 'bg-white/[0.03] border-gray-800'
                                }`}
                            >
                                <p className={`text-[11px] font-bold uppercase tracking-widest mb-2 ${tier.featured ? 'text-[#D8BA63]' : 'text-gray-500'}`}>
                                    {tier.subs} suscriptores
                                </p>
                                <p className="text-[11px] text-gray-600 font-mono mb-3">
                                    {tier.subs} × ${price} × 90%
                                </p>
                                <p className={`text-4xl font-black tracking-tight mb-2 ${tier.featured ? 'text-[#E2C96E]' : 'text-white'}`}>
                                    {formatMoney(net)}
            ...
            <style jsx>{`
                .slider-blue::-webkit-slider-thumb {
                    ...
                    cursor: grab;
                    box-shadow: 0 0 20px rgba(201, 168, 76,0.5), 0 0 0 4px rgba(201, 168, 76,0.15);
